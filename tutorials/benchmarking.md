...
MethodInstance for Main.workspace#4.double(::Dict{Symbol, AbstractFloat}, ::Symbol)
  from double(mapping, key::Symbol) in Main.workspace#4 at /home/runner/work/ownpapers/ownpapers/tutorials/benchmarking.jl#==#3f0e2049-8597-4dac-b499-4d7a8a35978e:1
Arguments
...
BenchmarkTools.Trial: 10000 samples with 991 evaluations.
 Range (min … max):   44.905 ns … 21.941 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):      47.529 ns              ┊ GC (median):    0.00%
 Time  (mean ± σ):   125.654 ns ±  1.013 μs  ┊ GC (mean ± σ):  0.80% ± 1.68%

  ▂▇█▅▄▄▂   ▂▂▁                                                ▂
  ███████▇█████▇▇▆▆▅▅▃▃▄▁▃▃▁▁▁▃▁▃▃▁▁▁▃▁▁▁▁▁▄▁▁▁▁▁▁▁▁▁▃▁▁▁▁▁▁▁▃ █
  44.9 ns       Histogram: log(frequency) by time       110 ns <
...
BenchmarkTools.Trial: 10000 samples with 997 evaluations.
 Range (min … max):  22.969 ns …  16.128 μs  ┊ GC (min … max): 0.00% … 0.00%
 Time  (median):     24.875 ns               ┊ GC (median):    0.00%
 Time  (mean ± σ):   54.920 ns ± 483.381 ns  ┊ GC (mean ± σ):  0.87% ± 1.38%

  ▃▅▃▁   ██▅▂▁       ▁▂▂▁▁        ▁▁▁     ▃▄▄▄▄▃▃▃▃▂▁▁         ▂
  ████▆▅▆██████▇▇▇▇████████▆▅▅▅▁▅▇████▇▆▇▇██████████████▇▇▆▇▅▅ █
  23 ns         Histogram: log(frequency) by time      36.5 ns <
